    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="jhipsterVueApp.bankAccount.home.createOrEditLabel" v-text="$t('jhipsterVueApp.bankAccount.home.createOrEditLabel')">Create or edit a BankAccount</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterVueApp.bankAccount.name')" for="bank-account-name">Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterVueApp.bankAccount.balance')" for="bank-account-balance">Balance</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('jhipsterVueApp.bankAccount.user')" for="bank-account-user">User</label>
