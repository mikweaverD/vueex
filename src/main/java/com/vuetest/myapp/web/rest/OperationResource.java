...
import com.vuetest.myapp.domain.Operation;
import com.vuetest.myapp.repository.OperationRepository;
...
/**
 * REST controller for managing {@link com.vuetest.myapp.domain.Operation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
