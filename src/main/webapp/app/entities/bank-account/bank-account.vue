<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('jhipsterVueApp.bankAccount.home.title')" id="bank-account-heading">Bank Accounts</span>
            <router-link :to="{name: 'BankAccountCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-bank-account">
                ...
                <span  v-text="$t('jhipsterVueApp.bankAccount.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && bankAccounts && bankAccounts.length === 0">
            <span v-text="$t('jhipsterVueApp.bankAccount.home.notFound')">No bankAccounts found</span>
        </div>
        <div class="table-responsive" v-if="bankAccounts && bankAccounts.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('jhipsterVueApp.bankAccount.name')">Name</span></th>
                    <th><span v-text="$t('jhipsterVueApp.bankAccount.balance')">Balance</span></th>
                    <th><span v-text="$t('jhipsterVueApp.bankAccount.user')">User</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="jhipsterVueApp.bankAccount.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-bankAccount-heading" v-text="$t('jhipsterVueApp.bankAccount.delete.question', {'id': removeId})">Are you sure you want to delete this Bank Account?</p>
            </div>
